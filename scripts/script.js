...
// Agregando itens selecionados no carrinho
...
function addToCart(name, price) {
    ...
    // Se item já existir aumenta quantidade
    if(existingItem) {
    ...
    cart.forEach(item => {
        ...
        cartItemElement.innerHTML = `
            <div class="flex items-center justify-between">
                ...
                <button style="color:red" class="remove-from-cart-btn" data-name="${item.name}">Remover</button>
            </div>
        `;
...
// Verificando o horário de funcionamento
function checkOpen() {
    const data = new Date();
